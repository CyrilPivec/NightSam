...
class SamCommentController {
    ...
    func getAllComment(success: @escaping (JSON) -> Void, _id: String) {
        ...
        Alamofire.request(baseAPIUrl + "/sam/comment?samId=" + _id, method: .get, headers: headers).responseJSON { response in
